...
class _CustomMarkAttendancePageState extends State<CustomMarkAttendancePage> {
  ...
  List<DigitTableColumn> headerList(DateTime s, dynamic localizations) {
    return [
      ...
      DigitTableColumn(
        header: localizations.translate(app_i18.attendance.identityCardNumber),
        cellValue: "identityCardNumber",
      ),
      DigitTableColumn(
        header: localizations.translate(app_i18.attendance.phoneNumber),
        cellValue: "phoneNumber",
      ),
    ];
  }
